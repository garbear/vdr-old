...
bool cCaDescriptorHandler::AddCaDescriptors(TRANSPONDER_TYPE source, int transponder, int serviceId,
...
int cCaDescriptorHandler::GetCaDescriptors(TRANSPONDER_TYPE source, int transponder, uint16_t serviceId,
