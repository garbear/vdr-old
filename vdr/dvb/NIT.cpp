      ...
      case SI::SatelliteDeliverySystemDescriptorTag:
        {
          ...
          if (cSetup::Get().UpdateChannels >= 5)
          {
            bool found = false;
