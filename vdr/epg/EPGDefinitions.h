...
#define EPG_XML_ELM_TABLE         "table"
#define EPG_XML_ELM_EVENT         "event"
#define EPG_XML_ELM_TITLE         "title"
#define EPG_XML_ELM_SHORT_TEXT    "short_text"
#define EPG_XML_ELM_DESCRIPTION   "description"
